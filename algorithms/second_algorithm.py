...
def main():
    ...
    for j in range(len(y_coordinates)):
        map_for_figures.append([0]*len(x_coordinates))
    ...
    for i in range(points_count):
        ...
        answer_array.append(map_for_figures[binary_search(y_coordinates, second_coord)][binary_search(x_coordinates, first_coord)])
    print(*answer_array)
